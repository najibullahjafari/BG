...
const SECTIONS = {
  ...
  skills: {
    label: "Skills",
    fields: [
      ["label", "Label", "text"], ["blurb", "Description", "textarea"],
  ...
  messages: {
    ...
    fields: [
      ...
      ["message", "Message", "textarea"], ["status", "Status", "text"],
    ],
  },
};
